  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900 text-gray-100 py-8 px-4 sm:px-6 relative font-inter">
      ...
      >
        ...
        {/* Form Section */}
        <motion.div
          className="bg-gray-900/80 backdrop-blur-sm rounded-xl p-8 shadow-xl border border-gray-800/50"
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <motion.input
              ...
              className="w-full p-4 bg-gray-800/50 border border-gray-700/50 rounded-lg text-gray-100 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300"
              whileFocus={{ scale: 1.01, borderColor: '#3b82f6' }}
            />
            <motion.div
              className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition duration-300 ${
                dragActive ? 'border-blue-500 bg-gray-700/50' : 'border-gray-700/50 bg-gray-800/50'
              }`}
              ...
              onDrop={handleDrop}
              onClick={handleClick}
              whileHover={{ borderColor: '#3b82f6', backgroundColor: '#1f2937' }}
            >
              <label htmlFor="file-upload" className="block text-gray-200 text-sm font-medium mb-3">
                Upload Resume (PDF)
              </label>
              <input
                id="file-upload"
            ...
            <motion.button
              type="submit"
              className="w-full bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition duration-300 flex items-center justify-center text-sm font-medium disabled:bg-gray-600 disabled:cursor-not-allowed"
              disabled={isLoading}
