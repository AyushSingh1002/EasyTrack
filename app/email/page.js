  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900 text-gray-100 py-16 px-4 sm:px-8">
      ...
      >
        ...
        >
          <div className="space-y-6">
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-lg text-base font-medium hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 transition duration-300 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={isLoading}
        ...
        {generatedText && (
          <motion.div
            className="mt-8 bg-gray-900/90 backdrop-blur-md p-8 rounded-xl shadow-lg"
            variants={childVariants}
          >
            ...
            <div className="flex gap-4 mt-4">
              <motion.button
                onClick={handleCopy}
                className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition duration-300 pulse"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Copy
              ...
              <motion.button
                ...
                className="bg-gray-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-300 pulse disabled:opacity-50 disabled:cursor-not-allowed"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
              ...
              <motion.button
                onClick={handleSave}
                className="bg-gray-700 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-600 transition duration-300 pulse"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Save
